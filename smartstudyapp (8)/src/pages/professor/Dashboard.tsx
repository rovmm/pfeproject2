...
import { professorSessions, type SessionType } from '../../lib/mockData';
...
export default function ProfessorDashboard() {
  ...
  const [sessions, setSessions] = useState(professorSessions);
    ...
    setSessions((prev) => [
      {
        ...
        language: type === 'code' ? language.split(' ')[0].toUpperCase() : undefined,
        joinCode: code,
        studentsJoined: 0,
        status: 'open',
      },
        ...
        <div className="card" style={{ padding: 24, marginBottom: 26, boxShadow: 'var(--shadow-card)' }}>
          ...
          <div style={{ display: 'flex', gap: 12 }}>
            <Button
              onClick={() => {
                createSession();
                if (type === 'quiz') navigate('/professor/quiz-creator');
              }}
            >
