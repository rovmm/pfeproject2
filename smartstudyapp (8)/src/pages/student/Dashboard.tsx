...
import { studentSessions } from '../../lib/mockData';
...
export default function StudentDashboard() {
  ...
  function handleJoin() {
    ...
    const match = sessions.find((s) => s.joinCode.toLowerCase() === code.toLowerCase());
    if (!match) {
      pushToast('error', 'Invalid join code');
      return;
    }
    navigate(match.type === 'code' ? `/student/session/${match.id}/code` : `/student/session/${match.id}/quiz`);
  }
